      ...
      <div className="App">
        ...
        <footer className="footer bg-dark">
          <div className="container-fluid text-center">
            <p>Crafted with <span role="img" aria-label="love">❤️</span>, <a href="https://reactjs.org/">react</a>, <a href="http://getbootstrap.com/">bootstrap</a> and <a href="https://fontawesome.com/">font-awesome</a> in <span role="img" aria-label="france">🇫🇷</span>.</p>
          </div>
        </footer>
      </div>
    );
